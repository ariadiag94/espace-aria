...
// Printable ARIA quote — clean rebuild after logo asset update.
 ...
 return <main className="quote-print-page">
  ...
  <article className="quote-sheet">
   <header className="quote-header">
    <div className="quote-brand"><img className="quote-logo" src="/logo-aria.svg" alt="ARIA Diagnostics"/></div>
   ...
   <section className="acceptance"><div><h3>Bon pour accord</h3><p>Je reconnais avoir pris connaissance du présent devis et en accepter les conditions.</p></div><div className="accept-grid"><div><span>Date</span><div className="sign-line"/></div><div><span>Nom / qualité</span><div className="sign-line"/></div><div className="signature"><span>Signature précédée de la mention « Bon pour accord »</span><div className="signature-box"/></div></div></div></section>
